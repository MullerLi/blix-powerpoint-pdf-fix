...
相容 TrueType 修正版。Blix 是由 IBM Plex Sans TC 改名衍生而來的字型。
...
- Blix 修正專案：<https://github.com/MullerLi/blix-powerpoint-pdf-fix>
- Blix 修正字型：<https://github.com/MullerLi/blix-powerpoint-pdf-fix/tree/main/fonts/Blix>
- IBM Plex 官方專案：<https://github.com/IBM/plex>
- IBM Plex Sans TC 官方套件：<https://github.com/IBM/plex/tree/master/packages/plex-sans-tc>
- IBM Plex Sans TC 來源修正字型：<https://github.com/MullerLi/blix-powerpoint-pdf-fix/tree/main/fonts/IBM-Plex-Sans-TC-derived-fix>

## 致謝

感謝 IBM、IBM Plex 設計團隊、Bold Monday 與所有 IBM Plex 貢獻者，提供高品質且
可自由使用、研究、修改與散布的 IBM Plex 字型專案。亦感謝 SIL Open Font
License 建立開放字型協作的基礎，使 Blix 與本相容修正案得以延伸、驗證並公開
分享。
